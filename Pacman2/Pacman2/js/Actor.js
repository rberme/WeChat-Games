...
import { levelConfig, actorInitial, axisIncrement, actorMode, allDirection, tunneLadit, penExit, oppositeDirections, penRoutinePos, fruitPos } from './GameRes'
...
export default class Actor {
    ...
    changeActorMode(newMode) {
        ...
        switch (newMode) {
            case 0b00000001:
                ...
                break;
            case actorMode.RESET://0b00000010//回到固定目标点上
    ...
    updateTilePos(b) {//p
        ...
        if (this.ghost == false && this.mainRef.playfield[b[0]][b[1]].path == false) {
        ...
        //pacman吃掉路径上的点
        this.ghost == false && this.mainRef.playfield[b[0]][b[1]].dot && this.mainRef.dotEaten(this.id, b);
    ...
    updateTargetPos() {
        if (this.id == this.mainRef.playerCount && this.mainRef.dotsRemaining < this.mainRef.levels.elroyDotsLeftPart1 && this.mode == 2 && (!this.mainRef.lostLifeOnThisLevel || this.mainRef.actors[this.mainRef.playerCount + 3].mode != 16)) {
            ...
            b = this.mainRef.actors[this.targetPlayerId];
            switch (this.id) {
                case this.mainRef.playerCount:
                    this.targetPos = [b.tilePos[0], b.tilePos[1]];
                    break;
                case this.mainRef.playerCount + 1:
                    this.targetPos = [b.tilePos[0], b.tilePos[1]];
                    var c = axisIncrement[b.dir];
                    this.targetPos[c.axis] += 32 * c.increment;
                    if (b.dir == 1) this.targetPos[1] -= 32;
                    break;
                case this.mainRef.playerCount + 2:
                    var d = this.mainRef.actors[this.mainRef.playerCount],
                        f = [b.tilePos[0], b.tilePos[1]];
                    c = axisIncrement[b.dir];
                    ...
                    break;
                case this.mainRef.playerCount + 3:
                    c = this.mainRef.getDistance(b.tilePos, this.tilePos);
